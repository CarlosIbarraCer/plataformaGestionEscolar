...
urlpatterns = [
   ...
   #Create Admin (API endpoint)
        path('api/admin/', users.AdminView.as_view()),
    #Admin Data
    ...
    #Eventos académicos
        path('eventos/', eventos.EventosListCreateView.as_view()),
        path('eventos/<int:pk>/', eventos.EventosDetailView.as_view()),
        path('eventos/opciones/', eventos.EventoOptionsView.as_view()),
]
